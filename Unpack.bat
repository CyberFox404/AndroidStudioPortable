...
rem echo ^<application^> > "%~dp0AndroidStudioPortable\data\config\options\android.sdk.path.xml"
rem echo   ^<component name="AndroidSdkPathStore"^> >> "%~dp0AndroidStudioPortable\data\config\options\android.sdk.path.xml"
rem echo     ^<option name="androidSdkAbsolutePath" value="%~dp0AndroidStudioPortable\data\sdk" /^> >> "%~dp0AndroidStudioPortable\data\config\options\android.sdk.path.xml"
rem echo   ^</component^> >> "%~dp0AndroidStudioPortable\data\config\options\android.sdk.path.xml"
rem echo ^</application^> >> "%~dp0AndroidStudioPortable\data\config\options\android.sdk.path.xml"

rem setx ANDROID_SDK_ROOT "E:\ASP\ASP_Subscriptions\AndroidStudioPortable\data\sdk" /M
